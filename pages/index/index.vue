<template>
	<view class="m-store-store">
		<view class="m-store-banner">
			<view class="m-content">
				<view class="m-message">
					...
					<view class="m-phone" @click="phoneCall('13577495351')">
		...
		<m-footer-car @handleFn="showSpec(false)"></m-footer-car>
		<!-- 规格-模态层弹窗 -->
		<view class="popup spec" :class="specClass" @touchmove.stop.prevent="discard" @tap="hideSpec">
			...
			<view class="layer" @tap.stop="discard">
				<view class="m-shopcar-box">
					...
					<view v-for="(item,index) in cartList" :key="index" class="m-shopcar-item">
						<view class="m-title">
							{{item.name}}
						</view>
						<view class="m-price">
						...
						<view class="m-controne">
							<uni-number-box :_id="item.id" :count="item.count" :min="1" :max="100"></uni-number-box>
						</view>
						<view @tap="deleteCartItem(item.id)">删除</view>
					</view>
				</view>
				<m-footer-car @handleFn="showSpec(false)"></m-footer-car>
			</view>
...
<script>
	...
	import categroyList from '@/common/mock.js'
	import {
		mapState,
		mapGetters,
		mapActions
